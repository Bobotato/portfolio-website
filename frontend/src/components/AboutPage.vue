  ...
  <section class="flex flex-col items-center justify-center">
    ...
    <div class="flex flex-col m-8 gap-8 items-center text-center text-xl max-w-6xl">
      ...
      <p>
        ...
        <a href="https://www.smilepepper.com/" class="hover:text-blue-700">SmilePepper</a>.
      </p>
    </div>

    <div class="flex flex-col gap-8">
      <h1 class="font-bold text-center text-3xl">Languages & Frameworks</h1>
      ...
      <h1 class="font-bold text-center text-3xl mt-4">Technologies</h1>
      <div class="flex flex-row place-items-center justify-center">
        <div class="flex flex-col place-items-center justify-center">
      ...
      <h1 class="font-bold text-center text-3xl mt-4">Currently Learning</h1>
      <div class="flex flex-row place-items-center justify-center">
        <div class="flex flex-col place-items-center justify-center">
      ...
      <ul class="contact-menu flex flex-row my-2 gap-8 items-center">
        ...
        <li class="text-xs">
          <a class="block hover:text-green-700" href="https://instagram.com/bobotato" target="_blank" rel="noreferrer">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="1 1 22 22" fill="currentColor" class="h-12 w-12" aria-hidden="true">
        ...
        <li class="text-xs">
          <a class="block hover:text-green-700" href="https://sg.linkedin.com/in/alexanderbhojwani" target="_blank" rel="noreferrer">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" fill="currentColor" class="h-12 w-12" aria-hidden="true">
