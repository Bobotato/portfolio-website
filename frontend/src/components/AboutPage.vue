...
<main class="flex flex-col items-center justify-center">
  <div id="nav-menu" class="flex flex-col items-center justify-center">
    <RouterLink
      to="/"
      id="page-name"
      class="shine text-slate-800 font-bold text-5xl tracking-tighter text-center mt-8 mb-4 p-2 lg:text-7xl lg:m-8 dark:text-green-700"
      >About</RouterLink>

    <nav class="flex flex-row gap-2 text-slate-800 text-lg text-center lg:text-2xl lg:gap-8 dark:text-gray-300">
      <RouterLink to="/" class="hover:text-green-700">Home</RouterLink> |
      <div class="text-green-700 dark:text-green-700">About</div> |
  ...
  <div id="about-content" class="flex flex-col items-center justify-center max-w-xs lg:max-w-4xl">
    
    <img src="/assets/pictures/ProfilePicture.jpg" class="rounded-full mt-10 mb-4 w-56 h-56 "/>
    <p class="text-center text-3xl font-bold dark:text-gray-300">That's me (on the right).</p>

    <div id="about-me" class="flex flex-col mt-8 gap-8 items-center text-center text-lg lg:text-2xl dark:text-gray-300">
      <p class="font-light">
      ...
      <p class="font-light">
        ...
        <a href="https://www.smilepepper.com/" class="hover:text-blue-700">SmilePepper</a> as a junior SWE (among other roles).
      </p>
      <p class="font-light">
    ...
    <hr id="divider-1" class="my-12 w-3/5 border-green-900 border-1" />
    ...
    <div id="proficiencies" class="flex flex-col gap-12 font-light">
      ...
      <section id="technologies" class="dark:text-gray-300">
        ...
        <div class="flex flex-row flex-wrap place-items-center justify-center gap-y-2 lg:gap-x-4">
          <div class="flex flex-col place-items-center justify-center">
            <img src="/assets/fullColourIcons/awsIcon.svg" fill=currentColor class="h-24 w-24 dark:text-gray-300" />
      ...
      <section id="learning" class="dark:text-gray-300">
...
<footer class="flex flex-col justify-center items-center">
    ...
    <hr id="divider-footer" class="mt-12 mb-8 w-2/6 border-slate-800 dark:border-green-900 border-1" />
    ...
    <div id="contact-links" class="flex flex-col justify-center my-4">
      <section>
        <ul class="contact-menu flex flex-row my-2 gap-8 items-center">
          <li class="text-xs">
            <a class="block text-slate-800 dark:text-gray-300 hover:text-green-700 dark:hover:text-green-700" href="https://github.com/bobotato" target="_blank" rel="noreferrer">
              <span class="sr-only">GitHub</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="h-8 w-8" aria-hidden="true">
          ...
          <li class="text-xs">
            <a class="block text-slate-800 dark:text-gray-300 hover:text-green-700 dark:hover:text-green-700" href="https://sg.linkedin.com/in/alexanderbhojwani" target="_blank" rel="noreferrer">
              <span class="sr-only">Instagram</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="1 1 22 22" fill="currentColor" class="h-8 w-8" aria-hidden="true">
          ...
          <li class="text-xs">
            <a class="block text-slate-800 dark:text-gray-300 hover:text-green-700 dark:hover:text-green-700" href="https://instagram.com/bobotato" target="_blank" rel="noreferrer">
              <span class="sr-only">Linkedin</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" fill="currentColor" class="h-8 w-8" aria-hidden="true">
