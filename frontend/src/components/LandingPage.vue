...
<main class="flex flex-col items-center justify-center max-w-screen-md w-screen lg:max-w-full lg:h-screen">
  <div class="flex flex-col-reverse items-center lg:flex-row">
    <section class="flex flex-col items-center gap-8 -mt-20 lg:mt-0 lg:w-7/12 lg:items-start">
      ...
      <div id="name-header" class="shine">
        <div class="text-slate-800 text-5xl text-center font-bold tracking-tighter lg:text-left lg:text-8xl dark:text-green-500">
          Alexander
        </div>
        <div class="text-slate-800 text-center font-bold text-5xl tracking-tighter pb-4 lg:text-left lg:text-8xl lg:-mt-4 dark:text-green-500">
          Bhojwani
        </div>
      </div>
      ...
      <nav id="nav-menu-landing" class="flex flex-col items-center w-2/12 gap-4 text-2xl text-center lg:items-start lg:text-left dark:text-gray-300">
      ...
      <ul id="contact-menu-landing" class="flex flex-row mt-4 gap-8 items-center">
        <li class="text-xs">
          <a class="block text-slate-800 dark:text-gray-300 hover:text-green-700" href="https://github.com/bobotato" target="_blank" rel="noreferrer">
        ...
        <li class="text-xs">
          <a class="block text-slate-800 dark:text-gray-300 hover:text-green-700" href="https://sg.linkedin.com/in/alexanderbhojwani" target="_blank" rel="noreferrer">
        ...
        <li class="text-xs">
          <a class="block text-slate-800 dark:text-gray-300 hover:text-green-700" href="https://instagram.com/bobotato" target="_blank" rel="noreferrer">
