...
<template>
  <main
    class="flex flex-col items-center justify-center max-w-screen-md w-screen lg:max-w-full lg:h-screen"
  >
    <div class="flex flex-col-reverse items-center lg:flex-row">
      <section class="flex flex-col items-center gap-8 -mt-20 lg:mt-0 lg:w-7/12 lg:items-start">
        <div id="name-header" class="shine">
          <div
            class="text-slate-800 text-5xl text-center font-bold tracking-tighter lg:text-left lg:text-8xl dark:text-green-500"
          >
            Alexander
          </div>
          <div
            class="text-slate-800 text-center font-bold text-5xl tracking-tighter pb-4 lg:text-left lg:text-8xl lg:-mt-4 dark:text-green-500"
          >
            Bhojwani
          </div>
        </div>
        ...
        <div
          id="work-title"
          class="text-center text-slate-800 -mt-10 text-3xl lg:text-4xl dark:text-gray-300 lg:-mt-4"
        >
